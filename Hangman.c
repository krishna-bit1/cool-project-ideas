...
int main() {
	...
	printf("\n\t - Maximum 6 mistakes will be allowed.");

	printf("\n\t - All alphabet shoukd be in  lower case.");
	...
	do {
		...
		printf("\tEntet an alphabet in lower case : ");
	...
	if(win == NULL) {
		...
		printf("\n\tCongratulations Kanishk! You have won : %s\n\n", word);
		...
		printf("\n\n\tYou were too close.Better luck next time! Word was %s\n\n", word);
